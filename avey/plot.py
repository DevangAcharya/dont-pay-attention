...
def parse_config():
    ...
    parser.add_argument('--max_tokens', type=int, default=110000, help='maximum token length for evaluation')
    parser.add_argument('--interval', type=int, default=10000, help='interval for evaluation')
...
def plot_heatmap(df, args):
    ...
    base_name = Path(args.model_dir).stem
